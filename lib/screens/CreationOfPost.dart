...
class _CreationOfPostState extends State<CreationOfPost> {
  ...
  List mounths = [
    "Jan","fev","mar","avrl","mai","juin","juill","aout","sept","oct","nov","dec"
  ];
                          ...
                          child: RaisedButton(
                              ...
                              onPressed: () async{
                                ...
                                if(validate()){
                                  ...
                                  String mounth = mounths[now.month] ;
                                  String hour ;
                                  ...
                                  _date = "${now.day} $mounth " + hour +":"+minute ;

                                  int _nb ;

                                 await Firestore.instance.collection("Variables").document("S4Pi1NfgqK2B8UjNRHTS").get().then((value) {
                                    setState(() {
                                      _nb = value.data['countPost'];
                                      print(_nb);
                                    });
                                  });

                                  Fire(id:id).UploadaPost(_Title, _Category, _Text, id, _ImageUrl,a+1,_date,_nb);

                                  setState(() {
                                    ++_nb;
                                  });

                                   await Firestore.instance.collection("Variables").document("S4Pi1NfgqK2B8UjNRHTS").updateData(
                                      {
                                        'countPost':_nb,
                                      }
                                  );
