...
class Fire {
  ...
  Future UploadaPost(String title,String category,String text,String id,String imageurl,int nbrposts,String datePub,int nbrpost)async{
     try {
